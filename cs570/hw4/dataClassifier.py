...
def readCommand( argv ):
  ...
  parser.add_option('-c', '--classifier', help=default('The type of classifier'), choices=['mostFrequent', 'nb', 'naiveBayes', 'GDA', 'logisticRegression', 'lr', 'gpClassification', 'gpc'], default='mostFrequent')
  ...
  elif(options.classifier == "gpClassification" or options.classifier == "gpc"):
    classifier = gpClassification.gaussianProcessClassifier(legalLabels, "GPC", 123, options.data)
    options.classifier = "GPC"
  else:
